...
> For the supported Windows/macOS/Linux PostgreSQL verification workflow, see [`docs/local-development.md`](docs/local-development.md). For the frontend foundation, see [`docs/frontend-foundation.md`](docs/frontend-foundation.md). For event discovery routes and API behavior, see [`docs/event-discovery.md`](docs/event-discovery.md).
